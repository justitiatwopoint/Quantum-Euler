Quantum Euler 001 Hilbert Space (3|5)

#Problem Statement

Consider a quantum system with discrete, non degenerate spectrum of energy eigenstates labeled by integers
n = 1,2,3, ...
...
All other states are forbidden and contribute zero to physical observables. Define a symmetry projected observable
S(N) = Σₙ₌₁ⁿ⁻¹ Eₙ · P(n),
